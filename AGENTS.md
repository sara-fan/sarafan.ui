...
- The public notice controller loads only legal Ops for footer links, including anonymous visits, and retries catalogue failures without requiring a customer. Present its failures inline without hiding route content; load personal consent history only on consent routes. Keep this loading independent of authentication restoration and discard stale work after navigation or identity changes.
