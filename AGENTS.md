...
- Bind phone resolution, code requests and verification to the dialog operation's abort signal; invalidate and abort them on close, replacement or unmount. Recheck the operation after shared Ops loading and before issuing requests or accepting results. Display legal-kind names from Legal Ops.
